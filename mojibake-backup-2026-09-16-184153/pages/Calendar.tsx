...
import {
...
} from '../components/layout/GardenPage'
  ...
  /*
   * App owns the Plan â†’ Reality destination.
   *
  ...
  function getPlantLabel(
    ...
    if (
      ...
      return `${plant.plantName} Â· ${plant.variety}`
    }
  ...
  function Calendar({
    ...
    function recordEditingPlan() {
       ...
       * destination:
       *
       * Sow / Plant â†’ Plant Story
       * Move / Feed / Treat / Task â†’ Journal
       * Plant-out â†’ Journal + Growing Journey
       * Harvest â†’ Harvest Record
       * Buy â†’ Purchase Record
       */
      onRecordPlan(
        currentPlan,
      )
          ...
          <div className="sprig-calendar-search">
            ...
            <div className="sprig-calendar-search-row">
              <input
                ...
                placeholder="Search plants, journal notes, harvests, places, plansâ€¦"
          ...
          <section className="sprig-calendar-search-results">
            ...
            0 ? (
              <div className="sprig-calendar-empty-card">
                <p>
                  Sprig could not find anything matching â€œ{cleanedSearchQuery}â€ in the Calendar layers currently showing.
                </p>
              </div>
            ) : (
...
{isPlantOutPlan && (
              ...
              {planKind ===
                ...
                <div className="sprig-calendar-empty-card">
                  ...
                  <p>
                    ...
                    When you actually buy it, â€œRecord what happenedâ€
        ...
        <BackToTop targetId="sprig-calendar-top" />
      </GardenPage>
    </GardenLayout>
  )
}
