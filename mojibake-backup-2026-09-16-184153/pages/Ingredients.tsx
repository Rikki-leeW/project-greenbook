...
export default function Ingredients({
  ...
  return (
    <MainPageTemplate
      ...
      onHome={showArchivedStatus ? undefined : () => onNavigate('growing-places')}
      navigationAriaLabel="Ingredients navigation"
      eyebrow={showArchivedStatus ? "Garden Library · Archive" : "Garden Library"}
      title={title}
      intro={intro}
      headerActions={!showArchivedStatus ? <button type="button" className="journal-add-button" onClick={onAddIngredient}>+ New Ingredient</button> : undefined}
    >
