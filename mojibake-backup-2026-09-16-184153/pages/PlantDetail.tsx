...
export default function PlantDetail({
     ...
     *
     * If the gardener says "60â€“80 days from transplanting" and
    ...
    return (
        <>
            ...
            <DetailPageTemplate activePage="plants" onNavigate={onNavigate}>
                <div className="plant-story-page">
                    ...
                    <section className="story-section">
                        <div className="section-heading">
                            <h2>
                                {plant.displayName} â€” Harvest Story
                            </h2>
                        </div>
                        ...
                        <article className="story-info-card plant-detail-compact-card">
                            ...
                            <div className="plant-detail-harvest-action">
                                ...
                                >
                                    ðŸ§º Harvest {plant.displayName}
                                </button>
                            </div>
                        </article>
                ...
                <div className="quick-peek-actions">
                    ...
                    harvestTimingReference?.sourceType ===
                        ...
                        <button
                            ...
                            disabled
                        >
                            âœ“ Planted out · Date not recorded yet ·
                            Current
                        </button>
                    )}
