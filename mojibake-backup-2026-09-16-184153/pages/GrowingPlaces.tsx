...
function getProductSubtitle(
  ...
  if (
    ...
    return `${product.brand} Â· ${category}`;
  }
...
function getAddButtonLabel():
  ...
  switch (
    ...
    case 'places':
      return 'ï¼‹ Add a Growing Place';

    case 'setups':
      return 'ï¼‹ Add Soil or Setup';

    case 'ingredients':
      return 'ï¼‹ Add an Ingredient';

    case 'products':
      return 'ï¼‹ Add a Product';
              ...
              >
                ...
                >
                  ...
                  <span className="growing-index-row-meta">
                    ...
                    {ingredient.manufacturer
                      ? ` Â· ${ingredient.manufacturer}`
                      : ''}

                    {usedByCount >
                    0
                      ? ` Â· used in ${usedByCount} ${
                          usedByCount ===
                          1
                            ? 'setup'
                            : 'setups'
