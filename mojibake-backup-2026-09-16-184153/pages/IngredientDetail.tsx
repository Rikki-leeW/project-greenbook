...
function getPurchaseSummary(
  ...
  if (
    purchase.packageSize !== undefined
  ) {
    const packageUnit =
      formatPurchaseUnit(
...
export default function IngredientDetail({
  ...
  return (
    <DetailPageTemplate activePage="library" onNavigate={onNavigate} className="journal-page" as="div" pageId="ingredient-detail-top">
        ...
        <section className="library-grid">
          ...
          <article className="library-book">
            ...
            0 ? (
              ...
              <p>
                This Ingredient has not been
                added to a Growing Recipe yet.
              </p>
            )}
          </article>
          ...
          <article className="library-book">
            ...
            {onAddPurchase && (
              ...
              >
                ðŸ›’ Bought this again
              </button>
            )}

            <p className="form-whisper">
              Each purchase stays separate so
              Sprig can remember changing
          ...
          <article className="library-book">
            ...
            <p>
              ...
              longer use while keeping their
              notes, photographs, Growing
              Recipe connections and purchase
              history.
            </p>
          </article>
        </section>
