        ...
        harvest => {
            ...
            options.push({
                ...
                label:
                    plantNames.length >
                    0
                        ? `Harvest Â· ${plantNames.join(
                              ', ',
                          )}`
                        : `Harvest Â· ${formatDate(
                              harvest.date,
                          )}`,
    ...
    (
        ...
        purchase => {
            options.push({
                ...
                label:
                    `${purchase.itemName} Â· ${formatDate(
                        purchase.date,
                    )}`,
    ...
    (
        ...
        plant => {
            ...
            if (
                ...
                ensureThread(
                    `${plant.plantName} Â· ${plant.variety.trim()}`,
                ).plantStoryCount +=
                    1;
            }
        },
        ...
        .forEach(
            reference => {
                ...
                if (
                    ...
                    ensureThread(
                        `${reference.plantName} Â· ${reference.variety.trim()}`,
                    ).referenceCount +=
                        1;
                }
            },
...
export default function GardenKnowledge({
    ...
    function getNoteExportDocument(
        ...
        if (
            ...
            sections.push({
                heading:
                    'Original imported note Â· preserved snapshot',
                        ...
                        <section className="sprig-knowledge-paper sprig-knowledge-capture">
                            ...
                            <label className="sprig-knowledge-field">
                                <span>
                                    ...
                                    <small>
                                        {' '}
                                        optional Â· type your own or reuse one
                                    </small>
                                </span>
                                ...
                                source => (
                                    ...
                                    >
                                        <div>
                                            <span className="sprig-knowledge-card-kicker">
                                                {source.category
                                                    ? `${source.category} Â· ${getSourceKindLabel(
                                                          source,
                                                      )}`
                                                    : getSourceKindLabel(
                                                          source,
                ...
                <section className="sprig-knowledge-paper sprig-knowledge-almanac-intro">
                    ...
                    <details className="sprig-knowledge-paper">
                        ...
                        <p>
                            ...
                            here as â€œFrom your gardenâ€, with the
            ...
            >
                {journeyBackLabel &&
                    ...
                    <GardenPageNavigation
                        ...
                        ariaLabel={`${getPageTitle()} navigation`}
                    />
                )}
                ...
                {view ===
                    'sources' &&
                    renderSourcesView()}
                            <BackToTop targetId="garden-knowledge-top" />
            </GardenPage>
        </GardenLayout>
    );
}
