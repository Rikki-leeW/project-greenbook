...
async function handleExportGardenReport() {
  ...
  return (
    <DetailPageTemplate activePage="comparison" onNavigate={onNavigate} className="journal-page sprig-comparison-report" as="main">
                            ...
                            <ul>
                              {insight.evidence.map(
                                (
                                  ...
                                  const evidenceText =
                                    evidence.detail
                                      ? `${evidence.label} Â· ${evidence.detail}`
                                      : evidence.label
