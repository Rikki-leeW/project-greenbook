...
export default function GrowingRecipeDetail({
  ...
  return (
    <DetailPageTemplate activePage="library" onNavigate={onNavigate} className="journal-page" as="div" pageId="growing-recipe-detail-top">
