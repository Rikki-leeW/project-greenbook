      ...
      ;(
        ...
        observation => {
          pushPhotos({
            ...
            subtitle:
              `Trial observation Â· ${formatDate(
                observation.date,
              )}`,
   ...
   <GardenPage
    ...
    >
      <GardenPageNavigation
        ...
        ariaLabel="Garden Gallery navigation"
      />
          ...
          >
            ...
            >
              ...
              <div className="sprig-gallery-viewer-scroll">
                ...
                <BackToTop targetId="garden-gallery-top" />
      </GardenPage>
    </GardenLayout>
  )
}
