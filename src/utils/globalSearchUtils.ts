...
import {
  getSprigPhotoEvidenceForSource,
  getSprigPhotoEvidenceSearchTerms,
} from './photoEvidence'
...
export function buildGlobalSearchIndex(
  ...
  /*
   * Photographs remain owned by their real
   * source records. Search enriches that real
   * record with photographic evidence instead
   * of creating a duplicate navigation path.
   */
