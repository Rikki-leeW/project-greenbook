...
/* =======================================
   PLURALISE CROP LABEL
======================================= */

function pluraliseCropLabel(
  value:
    string,
...
function buildSmartComparisonSuggestions(
  ...
  for (
    ...
    let title =
      `${comparisonCropLabel}: ${comparisonPlants.length} stories worth looking at together`
    ...
    if (
      ...
      title =
        `See how ${comparisonCropLabel} differed across places and Growing Recipes`
    } else if (
      places.length >
      1
    ) {
      title =
        `See how ${comparisonCropLabel} differed between Growing Places`
    } else if (
      setups.length >
      1
    ) {
      title =
        `See how ${comparisonCropLabel} differed between Growing Recipes`
    } else if (
      varieties.length >
      1
    ) {
      title =
        `Look across your ${comparisonCropLabel} varieties`
    } else if (
      activeCount >
        0 &&
      completedCount >
      ...
      title =
        `Compare these ${comparisonCropLabel} across current and earlier stories`
    }
        ...
        {!compareMode && (
          <>
            ...
            {smartComparisonSuggestions.length >
              0 && (
              <details className="dashboard-section plant-smart-comparisons">
                <summary className="plant-smart-comparison-summary">
                  <span className="plant-smart-comparison-summary-mark" aria-hidden="true">
                    <img
                      src={sprigPortrait}
                      alt=""
                    />
                  ...
                  <span className="plant-smart-comparison-summary-copy">
                    <span className="section-label">
                      Sprig noticed · Worth comparing
                    </span>

                    <strong>
                      {smartComparisonSuggestions.length}{' '}
                      {smartComparisonSuggestions.length === 1
                        ? 'useful comparison'
                        : 'useful comparisons'}
                    </strong>

                    <small>
                      Optional insights from your growing stories
                    </small>
                  </span>

                  <span className="plant-smart-comparison-summary-action">
                    <span className="plant-smart-comparison-open-label">
                      Show
                    </span>
                    <span className="plant-smart-comparison-close-label">
                      Hide
                    </span>
                    <span className="plant-smart-comparison-chevron" aria-hidden="true">
                      ›
                    </span>
                  </span>
                </summary>

                <div className="plant-smart-comparison-content">
                  <div className="plant-smart-comparison-intro">
                    <h2>
                      What might be worth a closer look
                    </h2>

                    <p>
                      These groups contain recorded differences. Open a comparison only when one feels useful.
                    </p>
                  </div>
                  ...
                  <div className="plant-smart-comparison-list">
                    {smartComparisonSuggestions.map(
                      suggestion => (
                        ...
                        >
                          <div className="plant-smart-comparison-main">
                            <p className="plant-smart-comparison-crop">
                            ...
                            <div
                              className="plant-smart-comparison-reasons"
                              aria-label="Useful differences"
                            >
                          ...
                          <button
                            type="button"
                            className="secondary-button plant-smart-comparison-button"
                            onClick={() =>
                          ...
                          >
                            Compare {suggestion.plantIds.length} stories →
                          </button>
                        </article>
                      ),
                    )}
